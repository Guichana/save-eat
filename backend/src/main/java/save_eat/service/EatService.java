...
public class EatService implements EatCreateUsecase, EatReadUsecase, EatListReadUsecase, EatDeleteUsecase {
    ...
    public void delete(EatDeleteDto deleteDto) {
        Eat eat = eatRepository
            .findByUserIdAndId(deleteDto.getUserId(), deleteDto.getEatId())
            .orElseThrow(ResourceNotFoundException::new);
